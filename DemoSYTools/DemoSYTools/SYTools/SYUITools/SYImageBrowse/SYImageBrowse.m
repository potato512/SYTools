...
- (void)resetPagelabelUI
{
    if (self.pageNormalColor || self.pageSelectedColor)
    {
        ...
        {
            [currentPageAtt attributedText:currentPageStr font:self.textlabel.font color:_pageSelectedColor bgColor:NO];
        }
        if (self.pageNormalColor)
        {
            [normalPageAtt attributedText:normalPageStr font:self.textlabel.font color:_pageNormalColor bgColor:NO];
        }
